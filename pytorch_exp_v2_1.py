...
if __name__ == "__main__":
    ...
    model = train_model(train_src, train_tgt, test_src, test_tgt, vocab_size, label_num, epochs=100, dim=300, batch_size=1024, logfile="log/cross_entropy_acc.json")
    report, acc = evaluate_model(model, test_src, test_tgt)
    print(report)
    with open("log/pytorch_exp_v2_1.log", "w+") as fp:
        fp.write(report)